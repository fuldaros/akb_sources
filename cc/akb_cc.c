...
static const struct { const char * f, * s, * e; }
	author = { "Dmitry", "Fuldaros", "<litefros@gmail.com>" };
...
"Abstract:",
"",
"    This tool generates AKB binary :3.",
"",
0};

static const char usage[] = 
"Usage: akb_cc [-e date] [-m addr] [-i iopt] [-x cmnd] [-l lopt] [-rvDTCAh] -f script";
...
"",
"    Please consult the akb_cc(1) man page.",
"",
0};
